...
export default function FileCard({
  ...
  return (
    <div className="r relative m-3 grid max-h-40 max-w-3xl grid-cols-8 gap-3 bg-[url('/image/subject-picture/bg-card.svg')] bg-cover bg-center p-3 pl-5">
      <Image
      ...
      {isTutor ? (
        <div className="col-span-2 flex place-items-center justify-end">
          <Button
            ...
            className='h-12 flex-1 rounded-none bg-[url("/image/subject-picture/bg-download-button.svg")] bg-cover bg-center font-prompt text-lg text-white hover:text-white'
          >
            Download
          </Button>
        </div>
