...
import { AudioLines, ChartLine, FlaskConical, Biohazard, Laptop } from "lucide-react";
...
const ClassContainer: React.FC = () => {
  ...
  const mockClasses = [
    ...
    },
    {
      "data": {
        ...
        "description": "Exploring the fundamentals of quantum theory and its applications.",
        "tutor": ["Dr. Brown"],
        "location": "Lab 3",
    ...
    },
    {
      "data": {
        ...
        "description": "Understanding the principles of heredity and variation in organisms.",
    ...
    },
    {
      "data": {
        ...
        "description": "Introduction to algorithms and models for machine learning.",
        "tutor": ["Prof. Black"],
        "location": "Lab 5",
  ...
  return (
    <div className="gap-6 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 p-6 w-full">
        {
